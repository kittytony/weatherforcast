...
import com.youngpain.weatherf.bean.Casts;
import com.youngpain.weatherf.bean.Weather;
import com.youngpain.weatherf.util.WeatherUtil;
...
public class ShowWeather extends AppCompatActivity {
    ...
    private String url = "https://restapi.amap.com/v3/weather/weatherInfo?key=6d29a580912e6f4b7ffb3b057d1f9ab2&city=340104&extensions=all&out=json";
